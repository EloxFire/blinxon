    ...
    return(
      <div id="crew" className="">
        ...
        <div className="col-12 d-flex flex-wrap justify-content-center">
          ...
          <PhotoCard name="Yolande, aka 'Yoyo'" teamPlace="La 4L" text="4L née il y a 31 ans, bolide de mère en fille et en excellent état pour son âge plutôt... avancé ! Elle nous emmène partout au quotidien, et nous emmènera jusqu'à Marrakech sans le moindre pépin ! (On l'éspère du moins)." image="Yolande" years="31"/>}
        </div>
      </div>
    )
  }
